        ...
        <div class="container">
            <div class="row">
                                           ...
                                           $art_cat = false;
                                            foreach( $categories as $cat){
                                                ...
                                                if( $cat['id'] == $art['categorie_id']){
                                                    ...
                                                    $art_cat = $cat;
                                                    break;                      //для остановки скрипта когда закончаться категории
                                                }
                                            }
                                        ?>

                                        <small>Категория: <a href="articles.php?categorie=<?php echo $art_cat[''];?>">
                ...
                <!--===== section БЕЗОПАСНОСТЬ =====-->
                    <div class="block">
                        <a href="/articles.php?id=8">Все записи</a>
                        <h3>Безопасность [Новейшее]</h3>
                        <div class="block__content">
                            <div class="articles articles__horizontal">

                                <?php
                                $articles = mysqli_query($connection, "SELECT * FROM `articles` WHERE `categorie_id` = 8 ORDER BY `id` DESC LIMIT 10");
